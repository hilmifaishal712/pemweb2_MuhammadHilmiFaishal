<?php
require_once 'praktikum4/daftar_mahasiswa/daftar_mahasiswa.php';
...
$mahasiswa1 = new Mahasiswa('Azzam', getRandomNim());
$mahasiswa2 = new Mahasiswa('Anggi', getRandomNim());
$mahasiswa3 = new Mahasiswa('Hilmi', getRandomNim());
$mahasiswa4 = new Mahasiswa('Yusuf', getRandomNim());
