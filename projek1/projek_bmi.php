        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="projek_bmi.php" class="form-horizontal">
            ...
            <?php
            require_once 'BMI/class_bmi_pasien.php';
            $pasien_hardcode = ['kodePasien' => 'FX-PAS-001', 'tanggal' => '16-04-2022', 'nama' => 'Asep', 'jk' => 'Laki-laki', 'bb' => 55.7, 'tb' => 181, 'bmi' => 16.8, 'status' => 'Kekurangan Berat Badan', 'image' => 'kurus'];
