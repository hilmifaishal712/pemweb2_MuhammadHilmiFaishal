                ...
                <form action="<?= base_url('dosen/edit_dosen'); ?>" method="post">
                    ...
                    <div class="input-group flex-nowrap d-flex flex-column" style="gap: 5px;">
                        <div class="input-group-prepend">
                            ...
                            <input type="text" name="nidn" class="form-control" placeholder="Nomer Induk dosen" aria-label="Username" aria-describedby="addon-wrapping" value="<?= $query_dosen_detail->nidn; ?>" required>
                        </div>
                        <div class="input-group-prepend">
                        ...
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping">pendidikan_akhir</span>
                        ...
                        <a href="<?= base_url(); ?>dosen/index" class="btn btn-success w-25 mx-auto">Back</a>
                        <!-- <input class="btn btn-success w-25 mx-auto" type="submit" value="Back"> -->
                    </div>
                </form>
            </div>
        </div>
