<div class="container">
    <img src="<?= base_url('assets/back-end/template/') ?>dist/img/1.PNG" alt="Developer Photo's" class="shadow-lg">
    <h2 class="text-center display-4"><i>Welcome, <?= $this->session->userdata('name') ?></i></h2>
    <!-- <h2 class="text-center display-4"><i>@FranssMukti</i></h2> -->
    <p class="w-50 text-center d-block m-auto d-flex flex-column justify-content-center vertical">
